...
│   ├── enhanced-styles.css    # Additional component styles
│   └── components/
│       └── cards.css          # Card component styles
├── images/                    # Image assets
├── Projects/                  # Project demos and assets
│   ├── CV/                    # CV files and interactive version
│   ├── Vastly Sage/          # Vastly Sage project assets
│   ├── Konecta/              # Konecta project assets
│   └── Bank Card Project/    # Bank card project files
...
### Live Site
Visit the live portfolio at: [https://silas-matabane.github.io](https://silas-matabane.github.io)
